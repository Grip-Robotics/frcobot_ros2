...
std::string robot_command_thread::SetWeldMachineCtrlMode(std::string para){
    ...
    int mode = std::stoi(list.front());list.pop_front();
    int ioType = std::stoi(list.front());list.pop_front();
    std::cout<<"SetWeldMachineCtrlMode"<<mode<<"   "<<ioType<<std::endl;
   ...
   /* 如果处于重连流程，不需要再读取，直接返回 */
    ...
    if(!ctrl_state_store_buff.empty()){
        ...
        */
        ...
        msg.exaxistatus2[3] = ctrl_state.exaxis_status[1].exAxisALM;
        msg.exaxistatus2[4] = ctrl_state.exaxis_status[1].exAxisFLERR;
        msg.exaxistatus2[5] = ctrl_state.exaxis_status[1].exAxisNLMT;
        msg.exaxistatus2[6] = ctrl_state.exaxis_status[1].exAxisPLMT;
        msg.exaxistatus2[7] = ctrl_state.exaxis_status[1].exAxisAbsOFLN;
        msg.exaxistatus2[8] = ctrl_state.exaxis_status[1].exAxisOFLIN;
        msg.exaxistatus2[9] = ctrl_state.exaxis_status[1].exAxisHomeStatus;
        ...
        msg.exaxistatus3[3] = ctrl_state.exaxis_status[2].exAxisALM;
        msg.exaxistatus3[4] = ctrl_state.exaxis_status[2].exAxisFLERR;
        msg.exaxistatus3[5] = ctrl_state.exaxis_status[2].exAxisNLMT;
        msg.exaxistatus3[6] = ctrl_state.exaxis_status[2].exAxisPLMT;
        msg.exaxistatus3[7] = ctrl_state.exaxis_status[2].exAxisAbsOFLN;
        msg.exaxistatus3[8] = ctrl_state.exaxis_status[2].exAxisOFLIN;
        msg.exaxistatus3[9] = ctrl_state.exaxis_status[2].exAxisHomeStatus;
        ...
        msg.exaxistatus4[3] = ctrl_state.exaxis_status[3].exAxisALM;
        msg.exaxistatus4[4] = ctrl_state.exaxis_status[3].exAxisFLERR;
        msg.exaxistatus4[5] = ctrl_state.exaxis_status[3].exAxisNLMT;
        msg.exaxistatus4[6] = ctrl_state.exaxis_status[3].exAxisPLMT;
        msg.exaxistatus4[7] = ctrl_state.exaxis_status[3].exAxisAbsOFLN;
        msg.exaxistatus4[8] = ctrl_state.exaxis_status[3].exAxisOFLIN;
        msg.exaxistatus4[9] = ctrl_state.exaxis_status[3].exAxisHomeStatus;
        ...
        // std::cout<<"ctrl_state.ctrlBoxError:"<<ctrl_state.ctrlBoxError<<std::endl;
        ...
        // std::cout<<"msg.ctrlopenluaerrcode:"<<"1:"<<msg.ctrlopenluaerrcode[0]<<"2:"<<msg.ctrlopenluaerrcode[1]
        // <<"2:"<<msg.ctrlopenluaerrcode[2]<<"4:"<<msg.ctrlopenluaerrcode[3]<<std::endl;
        // _state_publisher->publish(msg);
        ...
        //V3.0.5
        msg.auxservoservoid = ctrl_state.auxservo_state.servo_id;                    /** 外部伺服状态 */
        msg.auxservoerrcode = ctrl_state.auxservo_state.servo_errcode;  
        msg.auxservostate = ctrl_state.auxservo_state.servo_state;  
        msg.auxservoactualpos = ctrl_state.auxservo_state.servo_actual_pos;  
        msg.auxservoctualspeed = ctrl_state.auxservo_state.servo_actual_speed;  
        msg.auxservoactualtorque = ctrl_state.auxservo_state.servo_actual_speed;  
        for(int i=0;i<8;i++){
            msg.extpioinput[i] = ctrl_state.extPioInput[i];                        /* 扩展DI  */
            msg.extpiooutput[i] = ctrl_state.extPioOutput[i];
        }
        for(int i=0;i<4;i++){
            msg.extadcinput[i] = ctrl_state.extAdcInput[i];
            msg.extadcoutput[i] = ctrl_state.extAdcOutput[i];
        }
        // std::cout<<"ctrl_state.extpiooutput:"<<"1:"<<ctrl_state.extPioOutput[0]<<"2:"<<ctrl_state.extPioOutput[1]
        // <<"2:"<<ctrl_state.extPioOutput[2]<<"4:"<<ctrl_state.extPioOutput[3]<<"5:"<<ctrl_state.extPioOutput[4]<<"6:"<<ctrl_state.extPioOutput[5]<<std::endl;
        
        // std::cout<<"msg.extpiooutput:"<<"1:"<<msg.extpiooutput[0]<<"2:"<<msg.extpiooutput[1]
        // <<"2:"<<msg.extpiooutput[2]<<"4:"<<msg.extpiooutput[3]<<"5:"<<msg.extpiooutput[4]<<"6:"<<msg.extpiooutput[5]<<std::endl;
        _state_publisher->publish(msg);
    }
}
